...
A graphical representation below illustrates the general workflow for constructing ISNs:

![isns_construction](https://github.com/ahryho/psychoISN/blob/main/materials/figures/isns_construction.jpg)

The following figure illustrates the projected-specific ISN construction, showcasing how biomarker data translates into network models that capture individual dynamics:
