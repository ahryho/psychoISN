...
<<<<<<< HEAD
dex_loc_df      <- rbind(as.data.frame(dex_cpg_anno_gr)[, c("seqnames", "start", "end")],
                         as.data.frame(dex_snp_anno_gr)[, c("seqnames", "start", "end")])
=======
...
<<<<<<< HEAD
veh_loc_df      <- rbind(as.data.frame(veh_cpg_anno_gr)[, c("seqnames", "start", "end")],
                         as.data.frame(veh_snp_anno_gr)[, c("seqnames", "start", "end")])

loc_df <- rbind(dex_loc_df, veh_loc_df) %>% unique() %>% mutate(ID = rownames(loc_df)) %>%
  select(chr = seqnames, start, end, ID)
=======
