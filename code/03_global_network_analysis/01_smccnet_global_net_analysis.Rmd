...
```{r out.width = "95%", include = T, eval = T}
(selected_meqtl <- intersect_cdm[1,])
```

```{r out.width = "95%", include = T, eval = T}
pdf(paste0(plt_dir, "f06_gl_net_box_plt_dex_veh.pdf"), compress = TRUE)
...
(selected_meqtl <- veh_cdm_unique[1, ])
```
...
(selected_meqtl <- dex_cdm_unique[25,  ])
```
